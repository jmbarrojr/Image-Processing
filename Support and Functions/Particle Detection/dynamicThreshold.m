function [Apar,particle_list] = dynamicThreshold(A,Ithr,Cthr,win,type)
%DYNAMICTHRESHOLD
% This function segments a PIV/PTV image to determine all the particles.
% This is based on Mikheev & Zubtsov (2008) paper.
%
% [Apar,particle_list] = dynamicThreshold(A,Ithr,Cthr,win,type)
...
%        type - 'segment-only','particle-list'
%
% Author: Julio Barros
% OIST 2019
